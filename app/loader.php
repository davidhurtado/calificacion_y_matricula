...
try{
    ...
    $query_config = $G->db->prepare("SELECT * FROM ".DB_PREFIX."config WHERE w_id = 1");
...
if ($G->user->isLogged()) {
    require_once(ROOT . DS . "app" . DS . "controllers" . DS . "datos.php");
}
